...
public class RedBlackBST<Key extends Comparable<? super Key>, Value> {
	...
	public static void main(String[] args) {
		...
		rbbst.put("0000000000079", "INDIANA LOTTO");
		rbbst.put("0000000000093", "treo 700w");
		rbbst.put("0000000000123", "Wrsi Riversound cafe cd");
		rbbst.put("0000000000161", "\"Dillons/Kroger Employee Coupon ($1.25 credit)\"");
		rbbst.put("0000000000178", "Outdoor Bag");
		rbbst.put("0000000001090", "Rountech Asset 1");

		for (String s : rbbst.keys("0000000000079","0000000001090")) {
			System.out.print(s + " ");
		}
	}
}

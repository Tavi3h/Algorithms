...
public class SeparateChainingHashSTEx3420<Key, Value> {
	 ...
	 * 构造函数
	 */
	public SeparateChainingHashSTEx3420() {
		this(INIT_CAPACITY);
	}

	@SuppressWarnings("unchecked")
	public SeparateChainingHashSTEx3420(int m) {
		this.m = m;
	...
	private void resize(int chains) {
		SeparateChainingHashSTEx3420<Key, Value> temp = new SeparateChainingHashSTEx3420<Key, Value>(chains);
		for (int i = 0; i < m; i++) {
